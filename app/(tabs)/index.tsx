  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View className="justify-between flex-row w-full my-5">
            <View className="">
              <Text className=" text-primary">DELIVER TO</Text>
              <TouchableOpacity className="items-center flex-row gap-x-1 mt-0.5">
                <Text className="text-dark-100">Croatia</Text>
                <Image source={images.google} className="size-3" resizeMode="contain" />
              </TouchableOpacity>
            </View>
            <CartButton />
          </View>
